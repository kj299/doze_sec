...
echo [void]$html.AppendLine('.ok{color:#00d26a;font-weight:bold;word-break:break-all}') >> "%PSRUN%"
echo [void]$html.AppendLine('.warn{color:#ffc107;font-weight:bold;word-break:break-all}') >> "%PSRUN%"
echo [void]$html.AppendLine('.crit{color:#ff4444;font-weight:bold;background:#3a0000;padding:4px 8px;border-radius:3px;word-break:break-all}') >> "%PSRUN%"
echo [void]$html.AppendLine('.info{color:#17a2b8;word-break:break-all}') >> "%PSRUN%"
...
echo [void]$html.AppendLine('pre{background:#0a0a1a;padding:12px;border-radius:4px;font-size:12px;line-height:1.4;color:#c8c8c8;max-height:400px;overflow-y:auto;white-space:pre-wrap;word-break:break-all}') >> "%PSRUN%"
