...
**Version 7.3** | 18-section audit | 84 MITRE ATT&CK techniques detected | 10 IOC categories
...
| `ttp_manifest.txt` | 107 | `TechID\|Tactic\|Name\|Actors\|Detection` | MITRE ATT&CK v14+ mapping |
