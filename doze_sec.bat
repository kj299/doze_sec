...
set "CTI_SKILL_PATH=C:\Users\khali\OneDrive\Documents\src\prompts\threat-intel\cyber_threat_skill.yaml.md"
...
echo.>> "%REPORT%"
echo ====================================================================>> "%REPORT%"
echo  PRE-FLIGHT COMPLETE - Starting 17-Section Security Audit>> "%REPORT%"
